...
Data for cryptocurrency application can be downloaded from coinmetrics.io. The data that was downloaded on 2024-04-07 and is used in the paper is in the folder Cleaned_Data. This data is free to share and adapt under the licence CC BY-NC 4.0  (ATTRIBUTION-NONCOMMERCIAL 4.0 INTERNATIONAL, available at https://creativecommons.org/licenses/by-nc/4.0/). 
